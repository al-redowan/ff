                ...
                <tbody>
                    {teams.length === 0 ? (
                        <tr className="border-t border-slate-700">
                            <td colSpan={4} className="text-center px-6 py-10 text-slate-400">
                                <p className="font-semibold text-lg">No teams to display</p>
                                <p className="text-sm mt-1">Add teams manually or import a file to get started.</p>
                            </td>
                        </tr>
                    ) : (
                        teams.map((team) => (
